...
//    }
    ...
    public static Cliente obterUsuarioClientePorEmail(String email) {
        ArrayList<Cliente>Clientes = obterUsuariosCliente();
        for (Cliente c : Clientes) {
    ...
    private static void cadastraUsuarioCliente(Cliente usuario){

        ArrayList<Cliente> usuarios = obterUsuariosCliente();
        ...
        if (!clienteExiste) {
            ...
            try (FileOutputStream fileOut = new FileOutputStream(arquivoClientes);
                ...
                for (Usuario u1 : usuarios) {
                    out.writeObject(u1); // Grava todos os produtos no arquivo
                }
    ...
    public static void cadastraCliente(String email,String nome,String senha){

        int id = obterUsuariosCliente().size()+1;
        cadastraUsuarioCliente(new Cliente(id,nome,email,senha));
    ...
    public static void salvaUsuarioClientes(ArrayList<Cliente> clientes){
        ArrayList<Admin> admins = obterUsuariosAdmins();
